<?php
class Task_Suunto_Catcher_Activity {
...
// 		curl_setopt($handler, CURLOPT_CONNECTTIMEOUT, 5);
	...
	public function save() {
		...
		Dao::begin();
		Dao::factory('Coord')->deleteByActivityId($this->_activityId);
		for($i = 0; $i < $rowCount; $i++) {
			...
			Dao::factory('Activity')->updateStatusByActivityId($this->_activityId, Dao_Activity::STATUS_DOWNLOADED);
		}
		Dao::commit();
	}
}